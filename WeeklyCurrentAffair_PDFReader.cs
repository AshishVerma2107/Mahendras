...
{
    public class WeeklyCurrentAffair_PDFReader : Fragment
    {
        private string _documentsPath = System.Environment.GetFolderPath(System.Environment.SpecialFolder.MyDocuments);
        private string _pdfPath;
        private string _pdfFileName = "thePDFDocument9.pdf";
        private string _pdfFilePath;
        private WebView _webView;
        private string _pdfURLweek = "";
        ...
        {
            View v = inflater.Inflate(Resource.Layout.W_Affair_PDFReader_Layout, container, false);

            _webView = v.FindViewById<WebView>(Resource.Id.pdfweek);

            _pdfURLweek = Arguments.GetString("pdfurlweeklyaffair", "");
