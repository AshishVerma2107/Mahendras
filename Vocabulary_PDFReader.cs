...
{
    public class Vocabulary_PDFReader : Fragment
    {
        ...
        {
            View v = inflater.Inflate(Resource.Layout.Vocabulary_PDFReader_Layout, container, false);

            _webView = v.FindViewById<WebView>(Resource.Id.pdfvocab);

            _pdfURL = Arguments.GetString("pdfurlvocabulary", "");
