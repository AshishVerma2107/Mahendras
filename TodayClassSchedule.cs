...
{
    public class TodayClassSchedule : Fragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            View v = inflater.Inflate(Resource.Layout.TodayClassSchedule, container, false);
            mRecycleView = v.FindViewById<RecyclerView>(Resource.Id.todayclassschedulelist);
            ...
            Spinner spinner = v.FindViewById<Spinner>(Resource.Id.todayclassscheduleSpinner);
